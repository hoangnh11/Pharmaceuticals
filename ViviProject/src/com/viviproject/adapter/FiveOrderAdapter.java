...
import com.viviproject.entities.EnLatestFiveOrder;

public class FiveOrderAdapter extends BaseAdapter{
	private List<EnLatestFiveOrder> _data;
    private EnLatestFiveOrder items;
    private Activity mActivity;
    private int index;
	
    public FiveOrderAdapter(Activity activity, List<EnLatestFiveOrder> data) 
	{
		 mActivity = activity;
        _data = data;
        index = 0;
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
        ...
        if (items != null) {
			...
			if (items.getDate() != null) {
				holder.tvTime.setText(items.getDate());
			}
