...
public final class HttpNetServices implements INetServices {
	...
	@Override
	public String delivery(NetParameter[] netParameters, String token, String id) throws Exception {
		HttpFunctionInfo functionInfo = HttpFunctionFactory.delivery(netParameters, token, id);
		return executer(functionInfo);
	}
	...
	@Override
	public String orderCancel(NetParameter[] netParameters, String token) throws Exception {
	...
	@Override
	public String storesNoSale(NetParameter[] netParameters) throws Exception {
		HttpFunctionInfo functionInfo = HttpFunctionFactory.storesNoSale(netParameters);
		return executer(functionInfo);
	}
	
	@Override
	public String getStoreWaitApprove(NetParameter[] netParameters) throws Exception {
	...
	@Override
	public String locationChange(NetParameter[] netParameters, String token) throws Exception {
		HttpFunctionInfo functionInfo = HttpFunctionFactory.locationChange(netParameters, token);
		return executer(functionInfo);
	}
}
