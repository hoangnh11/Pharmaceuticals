...
public class ItemListViewOrder extends BaseLinearLayout{
	...
	{
		super(context);
		initControl(R.layout.item_listview_create_order, context);
	...
	OnClickListener onTDClick = new OnClickListener() 
	{
        ...
        {
            if (_onTDClick != null)
            	_onTDClick.onClick(ItemListViewOrder.this);
        }
    };
    ...
    OnClickListener onCKClick = new OnClickListener() 
	{
        ...
        {
            if (_onCKClick != null)
            	_onCKClick.onClick(ItemListViewOrder.this);
        }
    };
    ...
    OnClickListener onOtherClick = new OnClickListener() 
	{
        ...
        public void onClick(View v)
        {
            if (_onOtherClick != null)
            	_onOtherClick.onClick(ItemListViewOrder.this);
        }
    };
    ...
    OnClickListener onMinusClick = new OnClickListener() 
	{
        ...
        public void onClick(View v)
        {
            if (_onMinusClick != null)
            	_onMinusClick.onClick(ItemListViewOrder.this);
        }
    };
    ...
    OnClickListener onPlusClick = new OnClickListener() 
	{
        ...
        public void onClick(View v)
        {
            if (_onPlusClick != null)
            	_onPlusClick.onClick(ItemListViewOrder.this);
        }
    };
