...
public class SearchCustomerProfit extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.linSearch:
			enStores = new EnArrayStores();
			customerAdapter = new SearchCustomerAdapter(SearchCustomerProfit.this, enStores.getStores());
	...
	OnClickListener onItemClickHandler = new OnClickListener() 
	{
        ...
        { 
            ...
            intent = new Intent(SearchCustomerProfit.this, CustomerDetails.class);
	...
	class Search extends AsyncTask<Void, Void, String> {
		...
		protected void onPreExecute() {
			progressDialog = new ProgressDialog(SearchCustomerProfit.this);
		...
		protected String doInBackground(Void... params) {
			if (!isCancelled()) {				
				...
				netParameter[0] = new NetParameter("access-token", BuManagement.getToken(SearchCustomerProfit.this));
		...
		protected void onPostExecute(String result) {
			...
			if (!isCancelled()) {
				if (result.equals(GlobalParams.TRUE) && enStores != null && enStores.getStores().size() > 0) {					
					...
					app.hideKeyboard(SearchCustomerProfit.this, edtFilter);
				}
			}
		}
	}
